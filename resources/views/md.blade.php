...
@section('title', 'MD — Mr. Hassan Mehmood | Globecon Construction LLC')
...
@php
    $leader = [
        'name' => 'Mr. Hassan Mehmood',
        'title' => 'Managing Director',
        'photo' => asset('images/team/WhatsApp Image 2025-11-14 at 12.13.33 AM.jpeg'),
        'photo2' => asset('images/team/WhatsApp Image 2025-11-22 at 11.07.57 PM.jpeg'), // Second photo
        'message' => 'On-site execution is where vision meets reality. Precision, safety, and team synergy — every time.',
        'experience' => '5+ years — civil engineering & project delivery',
        'speciality' => 'Structural execution, QA/QC, site safety',
        'stats' => [
            ['number' => '95%', 'label' => 'Schedule Adherence'],
            ['number' => '50+', 'label' => 'Projects Delivered'],
            ['number' => '15+', 'label' => 'Years Experience'],
            ['number' => '0', 'label' => 'Major Incidents']
        ],
        'kpis' => [
            ['title' => 'Schedule Adherence', 'value' => '95% target', 'icon' => '📅'],
            ['title' => 'Safety Performance', 'value' => 'TRIR & incident reduction', 'icon' => '🛡️'],
            ['title' => 'Cost Control', 'value' => '< 3% variance target', 'icon' => '💰'],
            ['title' => 'Quality Standards', 'value' => 'Zero major defects', 'icon' => '⭐']
        ],
        'projects' => [
            ['name' => 'Downtown Mixed-use Tower', 'desc' => 'Civil & foundation works'],
            ['name' => 'Industrial Park Infrastructure', 'desc' => 'Bulk earthworks & utilities'],
            ['name' => 'Residential Complex Phase II', 'desc' => 'Structural execution & finishing'],
            ['name' => 'Commercial Plaza Development', 'desc' => 'Complete civil works package']
        ],
        'expertise' => [
            ['title' => 'Structural Execution', 'desc' => 'Precision in concrete, steel, and foundation works'],
            ['title' => 'QA/QC Management', 'desc' => 'Rigorous quality control and assurance protocols'],
            ['title' => 'Site Safety', 'desc' => 'Zero-tolerance safety culture and protocols'],
            ['title' => 'Team Leadership', 'desc' => 'Managing large on-site teams effectively']
        ],
        'values' => [
            ['title' => 'Safety First', 'desc' => 'Zero compromise on safety standards'],
            ['title' => 'Precision Execution', 'desc' => 'Attention to every structural detail'],
            ['title' => 'Team Excellence', 'desc' => 'Building capable and motivated teams'],
            ['title' => 'Timely Delivery', 'desc' => 'Commitment to project timelines']
        ],
        'gallery' => [
            ['img' => 'https://images.unsplash.com/photo-1541888946425-d81bb19240f5?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80', 'title' => 'Site Supervision'],
            ['img' => 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80', 'title' => 'Quality Inspection'],
            ['img' => 'https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80', 'title' => 'Team Coordination']
        ]
    ];
@endphp
...
<header class="relative z-50 px-6 py-6 max-w-7xl mx-auto flex items-center justify-between content-section">
    ...
    <div class="text-sm text-silver-accent tracking-widest opacity-90 font-light glass-effect px-4 py-2 rounded-lg">GLOBECON CONSTRUCTION — MD</div>
</header>
...
<section class="relative min-h-screen flex items-center justify-center px-4 py-20 overflow-hidden stellar-bg content-section z-10">
    <div class="max-w-7xl mx-auto w-full">
        <div class="grid lg:grid-cols-2 gap-16 items-center">
            <!-- MD Image with Enhanced Effects -->
                ...
                <div class="cosmic-border rounded-2xl p-4 elegant-glow floating">
                    <div class="rounded-xl overflow-hidden crystal-card">
                        <img 
                            ...
                            loading="lazy"
                            onerror="this.src='https://images.unsplash.com/photo-1581091226033-d5c48150dbaa?ixlib=rb-4.0.3&auto=format&fit=crop&w=1000&q=80'"
                        >
                    </div>
                </div>
            ...
            <div class="space-y-8" data-aos="fade-left" data-aos-duration="1200" data-aos-delay="300">
                <div>
                    <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
                        <span class="hologram-text">{{ $leader['name'] }}</span>
                    </h1>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="flex items-center space-x-2">
                        <div class="w-8 h-8 bg-gold-accent rounded-full flex items-center justify-center">
                            <span class="text-deep-navy text-sm font-bold">✓</span>
                        </div>
                        <span class="text-silver-accent text-sm">{{ $leader['experience'] }}</span>
                    </div>
                    <div class="flex items-center space-x-2">
                        <div class="w-8 h-8 bg-gold-accent rounded-full flex items-center justify-center">
                            <span class="text-deep-navy text-sm font-bold">✓</span>
                        </div>
                        <span class="text-silver-accent text-sm">{{ $leader['speciality'] }}</span>
                    </div>
                </div>
                
                <div class="button-group pt-6">
                    <a 
                        href="/contact?subject=Operations%20Enquiry%20for%20MD" 
...
<section class="relative py-20 px-4 overflow-hidden cyber-grid content-section z-10">
    <div class="max-w-7xl mx-auto">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-6">
            @foreach($leader['stats'] as $index => $stat)
    ...
    <div class="max-w-7xl mx-auto">
        <div class="text-center mb-16" data-aos="fade-up">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                <span class="hologram-text">Performance Metrics</span>
            </h2>
            <p class="text-lg md:text-xl text-silver-accent max-w-3xl mx-auto">
                Key performance indicators that demonstrate operational excellence and project success
            </p>
        </div>
        
        <div class="kpi-grid">
            @foreach($leader['kpis'] as $index => $kpi)
            <div class="kpi-card magnetic-card" data-aos="flip-up" data-aos-delay="{{ $index * 100 }}">
                <div class="kpi-icon">{{ $kpi['icon'] }}</div>
                <h3 class="text-xl font-bold gold-accent text-center mb-3">{{ $kpi['title'] }}</h3>
                <p class="text-light-gray text-center leading-relaxed">{{ $kpi['value'] }}</p>
            </div>
            @endforeach
        </div>
    </div>
...
<section class="relative py-20 px-4 overflow-hidden elegant-grid content-section z-10">
    <div class="max-w-7xl mx-auto">
        <div class="text-center mb-16" data-aos="fade-up">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                <span class="text-gradient">Core Expertise</span>
            </h2>
            <p class="text-lg md:text-xl text-silver-accent max-w-3xl mx-auto">
                Specialized skills and knowledge driving excellence in civil construction and project delivery
            </p>
        </div>
        
        <div class="expertise-grid">
            @foreach($leader['expertise'] as $index => $expertise)
...
<section class="relative py-20 px-4 overflow-hidden luxury-gradient nebula-effect content-section z-10">
    <div class="max-w-7xl mx-auto">
        <div class="text-center mb-16" data-aos="fade-up">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                <span class="hologram-text">Notable Projects</span>
            </h2>
            <p class="text-lg md:text-xl text-silver-accent max-w-3xl mx-auto">
                Landmark projects demonstrating exceptional civil engineering and project management capabilities
            </p>
        </div>
        
        <div class="project-grid">
            @foreach($leader['projects'] as $index => $project)
            <div class="project-card magnetic-card" data-aos="zoom-in" data-aos-delay="{{ $index * 100 }}">
                <h3 class="text-xl font-bold gold-accent mb-3">{{ $project['name'] }}</h3>
                <p class="text-light-gray leading-relaxed">{{ $project['desc'] }}</p>
            </div>
            @endforeach
        </div>
    </div>
...
<section class="relative py-20 px-4 overflow-hidden elegant-grid content-section z-10">
    <div class="max-w-7xl mx-auto">
        <div class="text-center mb-16" data-aos="fade-up">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                <span class="text-gradient">Leadership Values</span>
            </h2>
            <p class="text-lg md:text-xl text-silver-accent max-w-3xl mx-auto">
                Guiding principles that shape operational excellence and team success
            </p>
        </div>
        
        <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            @foreach($leader['values'] as $index => $value)
...
<section class="relative py-20 px-4 overflow-hidden luxury-gradient nebula-effect content-section z-10">
    <div class="max-w-7xl mx-auto">
        <div class="text-center mb-16" data-aos="fade-up">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                <span class="hologram-text">Site Gallery</span>
            </h2>
            <p class="text-lg md:text-xl text-silver-accent max-w-3xl mx-auto">
                Capturing the precision and excellence of on-site execution and team leadership
            </p>
        </div>
        
        <div class="gallery-grid">
            @foreach($leader['gallery'] as $index => $item)
            <div class="gallery-item magnetic-card" data-aos="zoom-in" data-aos-delay="{{ $index * 150 }}">
                <img src="{{ $item['img'] }}" alt="{{ $item['title'] }}" class="rounded-xl">
                <div class="gallery-overlay rounded-xl">
                    <h4 class="font-bold text-gold">{{ $item['title'] }}</h4>
                </div>
            </div>
            @endforeach
        </div>
...
<section class="relative py-20 px-4 overflow-hidden luxury-gradient nebula-effect content-section z-10">
    <div class="max-w-4xl mx-auto text-center" data-aos="zoom-in" data-aos-duration="1200">
        <div class="cosmic-border rounded-2xl p-8 md:p-12 elegant-glow">
            <h2 class="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">
                <span class="hologram-text">Ready to Build with Precision?</span>
            </h2>
            <p class="text-lg md:text-xl text-light-gray mb-8 max-w-2xl mx-auto leading-relaxed">
                Partner with Globecon Construction and experience operational excellence that delivers projects on time, within budget, and to the highest quality standards.
            </p>
...
<footer class="relative py-12 px-4 overflow-hidden elegant-grid content-section z-10">
    <div class="max-w-7xl mx-auto text-center">
        ...
        <p class="text-silver-accent mt-2">Precision That Builds Excellence</p>
    </div>
</footer>
